...
<nav class="navbar navbar-expand-md nav_index_ym">
    ...
    <?php if (isset($_SESSION["email"]) && esAdmin($_SESSION["email"])): ?><a href="Panel_Admin_YM.php"><i class="incognito" class="bi bi-incognito"></i></a><?php endif; ?>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="d-flex ms-auto" role="search" id="form-buscar-Musica"> <!-- ms-auto para margen a la izquierda -->
            <input class="form-control me-2" type="text" name="usuario" id="Musica" placeholder="Ingrese el nombre a buscar" aria-label="Search">
            <input type="submit" value="Buscar" name="envio" class="btn btn-primary" onclick="consultar_en_tiempo_real_Musica()">
        </form>
    </div>
...
<div class="container contenido-bus">
    <div class="flex justify-center space-x-4 mb-6">
        <a href="Busqueda.php" class="LinkB"><button class="text-white py-2 px-4 rounded-full boton-bus">Artista
            ...
            <a href="#" class="LinkB"><button class="text-white py-2 px-4 rounded-full boton-bus">música
                </button></a>
...
<div class="container container-busqueda">
    ...
    <div class="row resultado" id="resultado_Musica" style=" overflow-y: auto;"></div>
